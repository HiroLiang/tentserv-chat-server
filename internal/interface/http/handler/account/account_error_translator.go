...
import (
	...
	"github.com/HiroLiang/tentserv-chat-server/internal/application/auth/usecase"
...
func HandleError(ctx *gin.Context, err error) {
	...
	errMap := []struct {
		...
		{usecase.ErrPasswordConfirmMismatch, errResponse{http.StatusBadRequest, "PASSWORD_CONFIRM_MISMATCH", "password confirmation does not match"}},
		...
		{usecase.ErrSelfSenderKeySyncInProgress, errResponse{http.StatusConflict, "SELF_SENDER_KEY_SYNC_IN_PROGRESS", "self sender key sync is already in progress"}},
